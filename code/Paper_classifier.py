...
# -*-coding:utf-8 -*-
'''
@File    :   Paper_classifier.py
@Time    :   2025/01/20 16:36:27
@Author  :   Bart Ortiz 
@Version :   1.0
...
# adapted from jennifer's github
...
uploaded_file='../data/pdfs/Making_biodiversity_work_for_coffee_prod.pdf'
chuncks = process_document(uploaded_file)
